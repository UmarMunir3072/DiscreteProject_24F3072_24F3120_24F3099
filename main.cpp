...
void showLiveMenu()
{
    ...
    cout << "1) Add Student (Module 5: Sets)" << endl;
    cout << "2) List Students (Module 5: Sets)" << endl;
    cout << "3) Add Course (Module 5: Sets)" << endl;
    cout << "4) List Courses (Module 5: Sets)" << endl;
    cout << "5) Add Faculty (Module 5: Sets)" << endl;
    cout << "6) List Faculty (Module 5: Sets)" << endl;
    cout << "7) Add Room (Module 5: Sets)" << endl;
    cout << "8) List Rooms (Module 5: Sets)" << endl;
    cout << "9) Add Prerequisite (Module 6: Relations)" << endl;
    cout << "10) Generate Schedule (Module 1: Scheduling)" << endl;
    cout << "11) Generate Groups (Module 2: Combinations)" << endl;
    cout << "12) Verify Induction (Module 3: Induction)" << endl;
    cout << "13) Enroll Student (Module 6: Relations)" << endl;
    cout << "14) Set Intersection (Module 5: Sets)" << endl;
    cout << "15) Analyze Relations (Module 6: Relations)" << endl;
    cout << "16) Assign Faculty (Module 7: Functions)" << endl;
    cout << "17) Assign Room (Module 6: Relations)" << endl;
    cout << "18) Analyze Functions (Module 7: Functions)" << endl;
    cout << "19) Prove Chain (Module 8: Proofs)" << endl;
    cout << "20) Consistency Check (Module 9: Consistency)" << endl;
    cout << "21) Benchmarks (Module 10: Efficiency)" << endl;
    cout << "22) Check Logic Conflicts (Module 4: Logic)" << endl;
    cout << "0) Exit" << endl;
    cout << "Choice: ";
}
